...
import com.djzhao.coolweather.gson.Forecast;
import com.djzhao.coolweather.gson.Weather;
import com.djzhao.coolweather.util.HttpUtil;
import com.djzhao.coolweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private ImageView bingDaliyPic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bing_daliy_pic = preferences.getString("bing_daliy_pic", null);
        if (bing_daliy_pic != null) {
            Glide.with(this).load(bing_daliy_pic).into(bingDaliyPic);
        } else {
            loadBingDaliyPic();
        }
    ...
    private void loadBingDaliyPic() {
        ...
        HttpUtil.sendOkHttpRequest(pic_url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                editor.putString("bing_daliy_pic", responseString);
                editor.apply();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(responseString).into(bingDaliyPic);
                    }
                });
            }
    ...
    private void initView() {
        bingDaliyPic = findViewById(R.id.bing_daliy_pic);
    ...
    private void requestWeather(String weatherId) {
        String weatherURL = "http://guolin.tech/api/weather?cityid=" +
                weatherId + "&key=91f4cc83112b4b389b62d18b58977d6e";
